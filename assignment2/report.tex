...
$tr_0 \sim init(S_\star)$. Also,
$reach \models RD^\subseteq(S_\star)$, thus Corollary \ref{cor222} holds. Applying it
to $\pair{S_\star,\sigma,tr_0}$, knowing that $tr_0 \sim init(S_\star)$,
...
exclusions as well as unions of several sets from the argument. Thus, given a tuple with poitwise
