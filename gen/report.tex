...
trying ro ref program number \ref{prog}.
...
a $\breakc$ statement cause the program to jump immediately off the loop whilst
...
\begin{table}
\label{result_bc}
\caption{Strongly Live Variable Analysis with $\breakc$ and $\cont$}
\begin{sideways}
\input{result_bc.tex}
\end{sideways}
\end{table}
