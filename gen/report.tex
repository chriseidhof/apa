...
\def\programnew#1[#2]{\begin{progenv}\label{#2}\input{#1}\end{progenv}}
...
\restabR{Strongly Live Variable Analysis on Program \ref{prog} with $\iota = \{r\}$}{resultr.tex}[resultr]
...
\restab{Live Variable Analysis on Program \ref{prog}}{result1_lv.tex}[result_lv]
...
\programnew{progmassr.tex}[progmassr]
...
\programnew{progbc}[progbc]


\restabR{Strongly Live Variable Analysis on Program \ref{progbc} (with $\breakc$ and $\cont$)}{result_bc}[result_bc]
...
\programnew{progbc2.tex}[progbc2]
