...
\def\restabR#1#2{\begin{table}\begin{center}\caption{#1}\begin{sideways}\input{#2}\end{sideways}\end{center}\end{table}}

\def\restab#1#2{\begin{table}\begin{center}\caption{#1}\input{#2}\end{center}\end{table}}
...
\begin{table}
\caption{Strongly Live Variable Analysis with $\iota = \{a\}$}
\begin{sideways}
\input{resulta.tex}
\end{sideways}
\end{table}
...
\begin{table}
\caption{Strongly Live Variable Analysis with $\iota = \emptyset$}
\begin{sideways}
\input{resultempty.tex}
\end{sideways}
\end{table}
...
\program{\input{progbc}}


\program{\input{progbc2}}
