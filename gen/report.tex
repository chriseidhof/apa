...
We have also done Live Variable Analysis on the same program, yielding the results in Table \ref{result_lv}:
...
\restabR{Available Expression Analysis with $\break$ and $\cont$}{result_bc_ae}[result_bc_ae]
